...
> Versão atual: **1.2.1**. Este é um sistema interno; o `.env` de desenvolvimento usa segredos fictícios e dados de demonstração.
...
Imagens publicadas no **GHCR** (`ghcr.io/mond-day`), tag padrão **1.2.1**:
