...
Versão atual do monorepo: **1.2.1** (semver `MAJOR.MINOR.PATCH`).
...
Tags geradas em release (`v1.2.1`):
...
2. Atualize a versão nos `package.json` do root, apps e packages (`1.2.0` → `1.2.1`).
