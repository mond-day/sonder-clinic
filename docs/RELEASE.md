...
Versão atual do monorepo: **1.2.0** (semver `MAJOR.MINOR.PATCH`).
...
Tags geradas em release (`v1.2.0`):
...
2. Atualize a versão nos `package.json` do root, apps e packages (`1.1.6` → `1.2.0`).
