...
- **Google personal pull (A38):** pull-sync + overlay; oauth-status expõe `redirectUri`; Client ID/Secret na UI (1.3.5); mensagens MOCK orientam `GOOGLE_CALENDAR_MOCK=false` no Swarm
