...
| Integrações | `*_MOCK` + credenciais; Google: Client ID/Secret na UI (ou `GOOGLE_CLIENT_*` opcional) + redirect da UI / `GOOGLE_REDIRECT_URI`; Evolution: `EVOLUTION_BASE_URL`/`API_KEY`/`INSTANCE` |
